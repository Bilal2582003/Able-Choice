...
-- Date: Fri, 21 Jun 2024 16:28:09 +0200
...
SET autocommit=0;
INSERT INTO `address` VALUES (1,1,'surjani karachi','karachi','sindh','12345','paistan','2023-10-10 12:20:11',NULL,NULL),(2,2,'gulshan','karachi','sindh','09876','pakistan','2023-10-10 12:20:11',NULL,NULL);
/*!40000 ALTER TABLE `address` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `address` with 2 row(s)
--
...
SET autocommit=0;
INSERT INTO `product_category` VALUES (1,'massager','2023-10-08 03:30:04',NULL,NULL),(2,'game','2023-10-08 03:30:59',NULL,NULL),(3,'bunch','2023-10-17 20:23:27',NULL,NULL);
/*!40000 ALTER TABLE `product_category` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `product_category` with 3 row(s)
--
...
SET autocommit=0;
INSERT INTO `user` VALUES (1,'bilal','bilal@gmail.com','abubakar','03132004040','123','admin','2023-10-10 12:18:09','2024-06-11 21:08:05',NULL),(2,'hasan','abu@gmail.co','ali','0310220200','321',NULL,'2023-10-10 12:18:09','2024-03-31 18:02:49',NULL);
...
-- Dump completed on: Fri, 21 Jun 2024 16:28:09 +0200
